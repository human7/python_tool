...
def jd_cww_2(cnt_1=6, cnt_2=10):  # 京东 一级目录下的
    ...
    tapTask(cnt_1,  852, 1657, 5)  # 逛逛会场  次 1902 1657
    tapTask(cnt_2,  852, 1902, 5)  # 关注商品  次2130
...
if __name__ == "__main__":
    ...
    #jd_cww_1()  # 点我有惊喜 2级菜单
    #jd_cww_3(8)  # 京东 二级菜单，最开始关注店铺，拉到最底下
    #jd_cww_2(10, 8)  # 1级菜单，逛逛会场cnt_1次 和 关注商品cnt_2次
